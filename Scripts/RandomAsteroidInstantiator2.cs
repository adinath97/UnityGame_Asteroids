...
public class RandomAsteroidInstantiator2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(timer0 > timerCap0) {
            ...
            asteroidInstance.GetComponent<Rigidbody2D>().velocity = new Vector2(Random.Range(-2f,2f),Random.Range(-2f,2f));
        }
        if(timer1 > timerCap1) {
            timer1 = 0f;
            timerCap1 = Random.Range(lowerBound,upperBound);
